...
const router = (app) => {
  ...
  app.get(
    "/manageProfiles",
    mid.requiresLogin,
    controllers.Profile.profilesPage,
  );
  app.get("/getProfiles", mid.requiresLogin, controllers.Profile.getProfiles);
  app.post(
    "/createProfile",
    mid.requiresLogin,
    controllers.Profile.createProfile,
  );
  app.post(
    "/removeProfile",
    mid.requiresLogin,
    controllers.Profile.removeProfile,
  );
  ...
  app.get(
    "/getFavoriteVideos",
    mid.requiresLogin,
    controllers.Video.getSpecialVideos,
  );
  app.get(
    "/getWatchedVideos",
    mid.requiresLogin,
  ...
  app.post(
    "/addToFavorites",
    mid.requiresLogin,
    controllers.Video.addSpecialVideo,
  );
  app.post(
    "/addToWatched",
    mid.requiresLogin,
  ...
  app.post(
    "/removeFromFavorites",
    mid.requiresLogin,
    controllers.Video.removeFromFavorites,
  );
  app.get(
    "/",
    mid.requiresSecure,
